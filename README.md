...
flowchart TD
    ...
    WISDOM -->|"allow to examine our judgments and manage our responses, freeing us from destructive emotions like anger, fear, and envy that cause suffering."| HAPPINESS
    WISDOM -->|"provides clarity to distinguish between what we can and cannot control, help accepting what we cannot change and focusing on what we can control, leads to tranquility"| HAPPINESS

    COURAGE -->|"enables us to face life's challenges without disturbance, maintaining inner peace regardless of circumstances"| HAPPINESS
    
    JUSTICE -->|"fulfills our social nature and provides satisfaction through right relations with others in our community"| HAPPINESS
    
    TEMPERANCE -->|"prevents excessive desires and attachments that disturb tranquility, fostering contentment with what we have"| HAPPINESS
